		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "parkinglot",
									"targetURL": "#comappyardmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappyardmanagement-display": {
								"semanticObject": "comappyardmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.yardmanagement",
									"url": sap.ui.require.toUrl("com/app/yardmanagement")
								}
							}
						}
					}
